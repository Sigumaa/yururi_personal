...
func New(cfg config.Config, logger *slog.Logger) (*App, error) {
	...
	app.scheduler.Register("curiosity_review", jobHandlerFunc(app.handleCuriosityReviewJob))
	app.scheduler.Register("initiative_review", jobHandlerFunc(app.handleInitiativeReviewJob))
